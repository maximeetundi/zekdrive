...
ALTER TABLE users ADD COLUMN IF NOT EXISTS country VARCHAR(50) DEFAULT 'Cameroon';
...
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS country VARCHAR(50) DEFAULT 'Cameroon';
