...
@section('content')
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="mb-3 d-flex">
                <ul class="p-1 bg-white rounded nav nav--tabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{route('admin.report.earning')}}" class="nav-link active">{{translate('Earning')}}</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="{{route('admin.report.expense')}}" class="nav-link">{{translate('Expense')}}</a>
                    </li>
                </ul>
            </div>
            <div class="mb-4 row g-4">
                <div class="col-md-5">
                    <div class="card h-100">
                        <div
                            class="flex-wrap gap-10 pb-0 border-0 card-header d-flex justify-content-between align-items-center">
                            <h5 class="m-0 text-capitalize">{{translate('Earning Statistics')}}</h5>
            ...
            <h4 class="pt-2 mb-4 text-capitalize">{{ translate('Trip Wise Earning') }}</h4>
            <div class="card">
                <div class="card-body">
                        ...
                        <table class="table align-middle table-borderless table-hover text-nowrap trip-table">
                            ...
                            @empty
                                <tr>
                                    <td colspan="14">
                                        <div
                                            class="gap-2 py-3 d-flex flex-column justify-content-center align-items-center">
                                            <img
                    ...
                    <div
                        class="gap-2 table-bottom d-flex flex-column flex-sm-row justify-content-sm-between align-items-center">
                        <p class="mb-0"></p>
                        {{$trips->render()}}
                    </div>
                </div>
