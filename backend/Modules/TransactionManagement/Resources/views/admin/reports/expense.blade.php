...
@section('content')
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h4 class="mb-3 text-capitalize">{{ translate('Report Analytics') }}</h4>
            <div class="mb-3 d-flex">
                <ul class="p-1 bg-white rounded nav nav--tabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{route('admin.report.earning')}}" class="nav-link">{{translate('Earning')}}</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="{{route('admin.report.expense')}}" class="nav-link active">{{translate('Expense')}}</a>
                    </li>
                </ul>
            </div>
            <div class="mb-4 row g-4">
                <div class="col-md-5">
                    <div class="card h-100">
                        <div class="flex-wrap gap-10 pb-0 border-0 card-header d-flex justify-content-between align-items-center">
                            <h5 class="m-0 text-capitalize">{{translate('Expense Statistics')}}</h5>
                            ...
                            <div class="pt-3 w-100 border-bottom"></div>
                        </div>
                        <div class="card-body">
                            <div class="flex-wrap gap-4 d-flex align-items-center justify-content-center">
                                <div class="flex-grow-1">
                                    <table
                                        class="table align-middle table-borderless table-hover text-nowrap trip-table">
                                        <thead class="align-middle table-light text-capitalize">
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex-wrap gap-1 d-flex align-items-center">
                                                    <span class="px-2 pt-1 pb-2 rounded-1 bg-warning"></span>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex-wrap gap-1 d-flex align-items-center">
                                                    <span class="px-2 pt-1 pb-2 rounded-1 bg-info"></span>
                ...
                <div class="col-md-7">
                    <div class="card h-100">
                        <div class="flex-wrap gap-10 pb-0 border-0 card-header d-flex justify-content-between align-items-center">
                            <h5 class="m-0 text-capitalize">{{translate('Zone Wise  Statistics')}}</h5>
                            <div class="flex-wrap gap-2 d-flex flex-sm-nowrap align-items-center">
            ...
            <h4 class="pt-2 mb-4 text-capitalize">{{ translate('Trip Wise Expense') }}</h4>
            <div class="card">
                <div class="card-body">
                    <div class="flex-wrap gap-10 table-top d-flex justify-content-between">
                    ...
                    <div class="mt-3 table-responsive">
                        <table class="table align-middle table-borderless table-hover text-nowrap trip-table">
                            <thead class="align-middle table-light text-capitalize">
                            <tr>
                            ...
                            @empty
                                <tr>
                                    <td colspan="14">
                                        <div class="gap-2 py-3 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="gap-2 table-bottom d-flex flex-column flex-sm-row justify-content-sm-between align-items-center">
                        <p class="mb-0"></p>
                        {{$trips->render()}}
                    </div>
                </div>
