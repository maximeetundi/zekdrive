...
const DRIVER_ACCEPT_RIDE_CANCELLATION_REASON = [
    ...
    "Le client n'est pas arrivé au point de prise en charge",
    "Impossible d'atteindre le client en raison de la circulation dense",
    "Le client a demandé l'annulation",
    "Impossible de trouver ou de contacter le client"
];
...
const CUSTOMER_ACCEPT_RIDE_CANCELLATION_REASON = [
    "Emplacement sélectionné incorrect",
    "Le conducteur met trop de temps à arriver au point de prise en charge",
    "Le temps d'attente est trop long",
    "Le conducteur demande un tarif supplémentaire",
    "Le conducteur m'a demandé d'annuler"
];
