...
class PaymentItemInfoWidget extends StatefulWidget {
  ...
  const PaymentItemInfoWidget({super.key, required this.title,  this.icon, required this.amount,  this.isSubTotal = false,  this.isFromTripDetails = false, this.paymentType,  this.discount = false, this.toolTipText, this.subTitle});
    ...
    return Padding(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: Dimensions.paddingSizeExtraSmall),
            ...
            child: Text(PriceConverter.convertPrice(context, widget.amount), style: textSemiBold.copyWith(color: Get.isDarkMode? Colors.white : Theme.of(context).primaryColorDark))) :
        widget.paymentType!=null?
            Text(widget.paymentType!,style: textRegular.copyWith(color: Theme.of(context).primaryColor)):

        widget.discount?
        Text('-${PriceConverter.convertPrice(context, widget.amount)}', style: textRegular.copyWith(color: Get.isDarkMode? Colors.white : Theme.of(context).primaryColor)):
        Text(PriceConverter.convertPrice(context, widget.amount), style: textRegular.copyWith(color: Get.isDarkMode? Colors.white : Theme.of(context).primaryColor)),
