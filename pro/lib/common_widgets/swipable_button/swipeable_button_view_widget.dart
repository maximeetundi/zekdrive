...
import 'package:ride_sharing_user_app/common_widgets/swipable_button/swipeable_widget.dart';
...
class SwipeableButtonViewWidget extends StatefulWidget {
  ...
  const SwipeableButtonViewWidget(
      {super.key,
  ...
  @override
  SwipeableButtonViewWidgetState createState() => SwipeableButtonViewWidgetState();
}

class SwipeableButtonViewWidgetState extends State<SwipeableButtonViewWidget>
