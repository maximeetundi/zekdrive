                      ...
                      child: PaginatedListViewWidget(
                        ...
                        itemView: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return  channelUser != null ? MessageItemWidget(isRead: false, channelUsers: channelUser,unReadCount: chatController.channelModel!.data![index].unReadCount!,
                                lastMessage: chatController.channelModel!.data![index].lastChannelConversations?.message??'', tripId: chatController.channelModel!.data![index].tripId!): const SizedBox();
                          },
                        ),
                      ),
                    )
                ):
                 const Expanded(child: NoDataWidget(title: 'no_channel_found',)) : const Expanded(child: NotificationShimmerWidget()),
