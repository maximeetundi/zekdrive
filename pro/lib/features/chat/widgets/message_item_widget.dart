...
class MessageItemWidget extends StatelessWidget {
  ...
  const MessageItemWidget({super.key, required this.isRead, required this.channelUsers, required this.lastMessage, required this.tripId,this.unReadCount = 0});

  @override
  Widget build(BuildContext context) {
    return  InkWell(onTap: ()=> Get.to(()=>  MessageScreen(channelId: channelUsers.channelId!, tripId: tripId, userName:'${channelUsers.user!.firstName!} ${channelUsers.user!.lastName!}')),
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.center,
            mainAxisAlignment: MainAxisAlignment.center, children:[
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(lastMessage.isNotEmpty ? lastMessage : 'send_an_attachment'.tr, style: textMedium.copyWith(
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text( DateConverter.isoDateTimeStringToDifferentWithCurrentTime(channelUsers.updatedAt!),
                  ...
                  Container(height: 20, width: 20, decoration: BoxDecoration(
                    ...
                    child: Center(child: Text(unReadCount.toString(), style: textRegular.copyWith(color: Theme.of(context).cardColor,fontSize: 10)))) : const SizedBox(),
                  ],
                )])),
              const SizedBox(width: Dimensions.paddingSizeSmall,),
            ],
