...
class _VehicleAddScreenState extends State<VehicleAddScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(title: 'add_vehicle'.tr, regularAppbar: true,),
      body: GetBuilder<ProfileController>(
        builder: (profileController) {
          return SingleChildScrollView(
           ...
           /*     TextFieldTitleWidget(title: 'vin_number'.tr,),
                TextFieldWidget(
          ...
          /*      TextFieldTitleWidget(title: 'transmission'.tr,),
                TextFieldWidget(
                  hintText: 'EX: AMT',
                  capitalization: TextCapitalization.words,
                  inputType: TextInputType.name,
        ...
        builder: (profileController) {
          return Container(height: 70,
            ...
            Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
              child: ButtonWidget(buttonText: 'submit'.tr, onPressed: (){
