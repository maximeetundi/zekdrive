                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                          Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                              Text('see_others'.tr, style: textSemiBold.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color, fontSize: Dimensions.fontSizeExtraLarge),),
                              ...
                              Container( width: Dimensions.dropDownWidth,
                                ...
                                child: DropdownButtonFormField2<String>(
                                  ...
                                  items: leaderboardController.selectedFilterType.map((item) => DropdownMenuItem<String>(
                                      value: item, child: Text(item.tr, style: textRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: leaderboardController.selectedFilterTypeName == item ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyMedium!.color)))).toList(),
                                  onChanged: (value) {
                         ...
                         Padding(padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault, Dimensions.paddingSizeExtraLarge,
                          ...
                          SizedBox(height: Get.height,child: const NotificationShimmerWidget()),
                      ],): Padding(padding: EdgeInsets.only(top: Get.height/5), child: const NoDataWidget(),): const NotificationShimmerWidget();
                    }
                  ),
                ),
              ),
