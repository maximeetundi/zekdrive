                ...
                background: GetBuilder<RideController>(
                    builder: (rideController) {
                      ...
                      return Stack(children: [
                        Padding(padding: EdgeInsets.only(bottom: riderController.sheetHeight - (Get.find<RiderMapController>().currentRideState == RideState.initial ? 80 : 20)),
                          ...
                          child: Align(alignment: Alignment.bottomRight,
                            child: GetBuilder<LocationController>(
                                builder: (locationController) {
                                  return CustomIconCardWidget(title: '', index: 5,icon: Images.currentLocation,
                                      onTap: () async {
                              ...
                              Get.off(()=> const DashboardScreen());
                                ...
                                child: Stack(children: [
                                  SizedBox(width: Dimensions.iconSizeExtraLarge,
                                      child: Image.asset(Images.mapToHomeIcon, color: Theme.of(context).primaryColor)),
                                  Positioned(top: 0, bottom: 0, left: 5, right: 5, child: SizedBox(width: 15,child: Image.asset(Images.homeSmallIcon, color: Theme.of(context).colorScheme.shadow)))
                                ],
                                )))),


                        /*if(riderController.currentRideState == RideState.accepted && riderController.isInside )
