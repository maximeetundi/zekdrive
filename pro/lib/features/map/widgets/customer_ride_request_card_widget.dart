                        ...
                        Expanded(child: ButtonWidget(buttonText: 'complete'.tr,
                          ...
                          if(rideRequest.paymentStatus == 'paid'){
                            Get.dialog(ConfirmationDialogWidget(
                              ...
                              onYesPressed: () {
                                if(Get.find<RideController>().matchedMode != null && (Get.find<RideController>().matchedMode!.distance! * 1000) <= Get.find<SplashController>().config!.completionRadius!){
                    ...
                    builder: (rideController) {
                      return Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault, vertical: Dimensions.paddingSizeDefault),
                        child: rideController.accepting ? SpinKitCircle(color: Theme.of(context).primaryColor, size: 40.0,): Row(children: [
                          Expanded(child: ButtonWidget(buttonText: (bidOn && rideRequest.type != 'parcel' && rideRequest.fareBiddings != null && rideRequest.fareBiddings!.isEmpty)? 'bid'.tr : 'reject'.tr,
                            transparent: true,
                            borderWidth: 1,
                            showBorder: true,
                            radius: Dimensions.paddingSizeSmall,
                            ...
                            onPressed: (){
                              if(bidOn && rideRequest.fareBiddings != null &&  rideRequest.fareBiddings!.isEmpty && rideRequest.type != 'parcel'){
                                showDialog(context: Get.context!, builder: (_)=>  BiddingDialogWidget(rideRequest: rideRequest,));
                              }else{
                          ...
                          Expanded(child:  ButtonWidget(buttonText: 'accept'.tr,
                            radius: Dimensions.paddingSizeSmall,
                            onPressed: () async{
