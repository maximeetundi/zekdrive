                                ...
                                if(riderController.currentRideState == RideState.initial)
                                  Padding(padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault,Dimensions.paddingSizeSmall, Dimensions.paddingSizeDefault,Dimensions.paddingSizeDefault),
                                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children:  [
                                        CustomIconCardWidget(title: 'refresh'.tr, index: 0,icon: Images.mIcon3, onTap: (){
                                         // riderController.setRideCurrentState(RideState.initial);
                                        }),
                                        CustomIconCardWidget(title: 'leader_board'.tr, index: 1,icon: Images.mIcon2, onTap: () => Get.to(()=> const LeaderboardScreen())),
                                        CustomIconCardWidget(title: 'trip_request'.tr, index: 2,icon: Images.mIcon1, onTap: () => Get.to(()=> const RideRequestScreen())),
                                      ])),
