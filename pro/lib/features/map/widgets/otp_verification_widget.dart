          ...
          return Column(children: [
            ...
            Align(alignment: Alignment.topRight,
                child: Container(padding: const EdgeInsets.symmetric(horizontal : Dimensions.paddingSizeSmall,vertical: Dimensions.paddingSizeExtraSmall),
                    ...
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(100), color: Theme.of(context).hintColor.withOpacity(.085)),
              ...
              Container(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSignUp),
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  otpTimeController.currentState == 0 ?
                  Text('collect_the_otp_from_customer'.tr, style: textRegular.copyWith()) :
                  Text('please_hold_on_a_little_more'.tr, style: textBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeDefault)),
                  ...
                  Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                    child: Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center, children: [
                      ...
                      InkWell(onTap: () async {
                        ...
                        child: rideController.isPinVerificationLoading ?  const SizedBox(width: 30,height: 30,child: CircularProgressIndicator()):
