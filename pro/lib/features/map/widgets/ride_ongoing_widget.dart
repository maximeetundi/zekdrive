...
class _RideOngoingWidgetState extends State<RideOngoingWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RideController>(builder: (riderController) {
      ...
      return currentState == 0 ? riderController.tripDetail != null
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Row(children: [
                                Stack(children: [
                                  ...
                                  ClipRRect(borderRadius : BorderRadius.circular(100),
                                      child: ImageWidget(width: 50,height: 50, image: riderController.tripDetail!.customer?.profileImage != null?
                                ...
                                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  if(riderController.tripDetail!.customer != null)
                                    Row(children: [
                                      ...
                                      Text(double.parse(riderController.tripDetail!.customerAvgRating!).toStringAsFixed(1), style: textRegular.copyWith())])],),
                              ],),

                              Container(width: 1,height: 25,color: Theme.of(context).primaryColor.withOpacity(0.15)),
                              InkWell(onTap : () => Get.find<ChatController>().createChannel(riderController.tripDetail!.customer!.id!,tripId: riderController.tripDetail!.id),
                                  child: SizedBox(width: Dimensions.iconSizeLarge,child: Image.asset(Images.customerMessage))),

                              Container(width: 1,height: 25,color: Theme.of(context).primaryColor.withOpacity(0.15)),
                              InkWell(onTap: ()=> Get.find<SplashController>().sendMailOrCall("tel:${riderController.tripDetail!.customer!.phone}", false),
                    ...
                    Padding(
                        ...
                        child: Container(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              PaymentItemInfoWidget(
                                  icon: Images.paymentTypeIcon, title: 'payment'.tr, amount: 234, paymentType: riderController.tripDetail!.paymentMethod!.replaceAll(RegExp('[\\W_]+'),' ').capitalize),
                            ]))),
                    ...
                    if (riderController.tripDetail != null &&
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.fontSizeExtraSmall), color: Theme.of(context).primaryColor),
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text(
                              '${'who_will_pay'.tr}?',
                    ...
                    (riderController.tripDetail!.isPaused!)
                        ...
                        : (!riderController.tripDetail!.isPaused! && riderController.tripDetail!.type == "ride_request")
                            ? Column(children: [
                                ...
                                ButtonWidget(buttonText: 'cancel_ride'.tr, textColor: Theme.of(context).colorScheme.error,backgroundColor: Colors.transparent,onPressed: (){
                                    currentState = 1;
                            ...
                            : SliderButton(
                              ...
                              dismissThresholds: 0.5, dismissible: false, shimmer: false, width: 1170, height: 40, buttonSize: 40, radius: 20,
                              icon: Center(
                                  child: Container(width: 36, height: 36, decoration: BoxDecoration(shape: BoxShape.circle, color: Theme.of(context).cardColor),
                                     child: Center(
                                      child: Icon(
                                       Get.find<LocalizationController>().isLtr ? Icons.arrow_forward_ios_rounded : Icons.keyboard_arrow_left,
          ...
          : const SizedBox() : Padding(padding: const EdgeInsets.symmetric(horizontal:Dimensions.paddingSizeDefault),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
               const SizedBox(height: Dimensions.paddingSizeSmall,),
              Text('your_trip_is_ongoing'.tr,style: textSemiBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall),),
              ...
              Row(children: [
                ...
                onPressed: (){
                 ...
                 Expanded(child: ButtonWidget(buttonText: 'submit'.tr,
                  ...
                  radius: Dimensions.paddingSizeSmall,
                  onPressed: (){
                    riderController.tripStatusUpdate('cancelled', riderController.tripDetail!.id!, "trip_cancelled_successfully", Get.find<TripController>().tripCancellationCauseList!.data![0].ongoingRide![Get.find<TripController>().tripCancellationCauseCurrentIndex]).then((value) async {
                      if(value.statusCode == 200){
