        ...
        return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
              child: Column(children:  [
                ...
                const SizedBox(height: 65 ,width: 10,child: DividerWidget(height: 2,dashWidth: 1,axis: Axis.vertical,)),
                if((extraOne != null && extraOne!.isNotEmpty) || (extraTwo != null && extraTwo!.isNotEmpty))
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                SizedBox(height: 40,
                    child: Text(pickupAddress, style: textRegular.copyWith(),maxLines: 2,overflow: TextOverflow.ellipsis,)),
                const SizedBox(height: Dimensions.paddingSizeExtraLarge),
                if(extraOne != null && extraOne!.isNotEmpty)
                Padding(padding: const EdgeInsets.only(left: Dimensions.paddingSizeSmall),
                  child: Text(extraOne!, style: textRegular.copyWith(color: Theme.of(Get.context!).primaryColor.withOpacity(.75),fontSize: Dimensions.fontSizeSmall),overflow: TextOverflow.ellipsis)),


                if((extraOne != null && extraOne!.isNotEmpty) || (extraTwo != null && extraTwo!.isNotEmpty))
                const Padding(padding: EdgeInsets.only(left: Dimensions.paddingSizeExtraSmall),
                  child: SizedBox(height:20 ,width: 10,child: DividerWidget(height: 2,dashWidth: 1,axis: Axis.vertical))),


              if(extraTwo != null && extraOne!.isNotEmpty)
                Padding(padding: const EdgeInsets.only(left: Dimensions.paddingSizeSmall),
                  child: Text(extraTwo!, style: textRegular.copyWith(color: Theme.of(Get.context!).primaryColor.withOpacity(.75),fontSize: Dimensions.fontSizeSmall),overflow: TextOverflow.ellipsis)),
