...
class ProfileController extends GetxController implements GetxService{
  ...
  Future<Response> updateProfile( String firstName, String lastName, email) async {
    isLoading = true;
    update();
    Response? response = await profileServiceInterface.updateProfileInfo(firstName, lastName,email ,Get.find<AuthController>().pickedProfileFile,Get.find<AuthController>().multipartList);
    if(response!.statusCode == 200){
      Get.back();
