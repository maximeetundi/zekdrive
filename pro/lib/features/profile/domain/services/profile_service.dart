...
class ProfileService implements ProfileServiceInterface{
  ...
  @override
  Future updateProfileInfo(String firstName, String lastname, String email, XFile? profile,List<MultipartBody>? identityImage) {
    return profileRepositoryInterface.updateProfileInfo(firstName, lastname, email, profile,identityImage);
  }
