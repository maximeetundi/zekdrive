    ...
    return Scaffold( resizeToAvoidBottomInset: true,
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeSmall),
                      child: Container(height: 80, width: Get.width,
                        ...
                        child: Center(child: InkWell(onTap: ()=> authController.pickImage(false, true),
                          child: Stack(alignment: AlignmentDirectional.center,
                             clipBehavior: Clip.none, children: [
                               authController.pickedProfileFile==null?
                               ClipRRect(borderRadius: BorderRadius.circular(50),
                                 child: ImageWidget(image: '${Get.find<SplashController>().config!.imageBaseUrl!.profileImage}/${widget.profileInfo.profileImage??''}',
                    ...
                    Row(children: [
                      ...
                      Padding(padding:const EdgeInsets.fromLTRB(10,17,0,8),
                        child: Icon(Icons.warning,color: Theme.of(context).colorScheme.primaryContainer,size: 12,)),

                      Padding(padding:const EdgeInsets.fromLTRB(5,17,0,8),
                        child: Text("phone_number_isn't_editable".tr,style: textRegular.copyWith(color: Theme.of(context).hintColor,fontSize: Dimensions.fontSizeSmall)))
                    ]),
                    TextFieldWidget(
                      borderRadius: 50,
                      hintText: 'phone',
                  ...
                  if(profileController.profileInfo?.identificationImage != null && profileController.profileInfo!.identificationImage!.isNotEmpty )
                    Padding(padding:  const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault, 0, Dimensions.paddingSizeDefault, 0),
                                  ...
                                  child: Stack(children: [
                                    ClipRRect(borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                        child:  SizedBox(height: MediaQuery.of(context).size.width/4.3,
                                            ...
                                            child: ImageWidget(image: '${Get.find<SplashController>().config!.imageBaseUrl!.identityImage}/${profileController.profileInfo!.identificationImage![index]}'))),
                  ...
                  if(profileController.profileInfo!.isOldIdentificationImage!)
                    Container(decoration: BoxDecoration(color: Colors.black.withOpacity(0.75),
                        ...
                        child: Padding(padding: const EdgeInsets.all(8.0),
                            child: Row(children: [
                              ...
                              Expanded(child: Text('please_wait_admin_approval_for_identity_info'.tr,style: textMedium.copyWith(color: Theme.of(context).cardColor,fontSize: Dimensions.fontSizeSmall)))])))
      ...
      bottomNavigationBar: GetBuilder<ProfileController>(
        builder: (profileController) {
          return SizedBox(height: 70,child:  profileController.isLoading? Center(child: SpinKitCircle(color: Theme.of(context).primaryColor, size: 40.0,)):
           Container(
             ...
             child: ButtonWidget(buttonText: 'submit'.tr,
