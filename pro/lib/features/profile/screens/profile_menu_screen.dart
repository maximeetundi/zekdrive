        ...
        children: [
          SingleChildScrollView(
            child: Column(children:   [
              ...
              ProfileMenuItem(icon: Images.privacyPolicy, title: 'privacy_policy', onTap: ()=> Get.to(()=>  PolicyViewerScreen(isPolicy: true, image: Get.find<SplashController>().config?.privacyPolicy?.image??'')),),
              ProfileMenuItem(icon: Images.termsAndCondition, title: 'terms_and_condition', onTap: ()=> Get.to(()=>  PolicyViewerScreen(image: Get.find<SplashController>().config?.termsAndConditions?.image??'')),),
              ProfileMenuItem(icon: Images.privacyPolicy, title: 'legal', onTap: ()=> Get.to(()=>  PolicyViewerScreen(isLegal: true, image: Get.find<SplashController>().config?.legal?.image??'')),),
              ...
              ProfileMenuItem(icon: Images.logOutIcon, title: 'permanently_delete_account'.tr, onTap: (){
                showDialog(context: context, builder: (_){
                  return GetBuilder<AuthController>(
                      builder: (authController) {
                        return ConfirmationDialogWidget(icon: Images.logOutIcon,
                          ...
                          description: 'permanently_delete_confirm_msg'.tr, onYesPressed: (){
