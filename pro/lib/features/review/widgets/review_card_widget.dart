              ...
              Padding(padding:  const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
                child: Row(children: [
                  Container(decoration: BoxDecoration(
                      ...
                      child: ClipRRect(
                          borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                          child:  ImageWidget(image: '${Get.find<SplashController>().config!.imageBaseUrl!.profileImageCustomer!}/${review.givenUser!.profileImage??''}',
                            height: 30,width: 30,))),
                  ...
                  GetBuilder<ReviewController>(
                      builder: (reviewController) {
                        return GestureDetector(
                          ...
                          child:review.isLoading! ? CircularProgressIndicator(color: Get.isDarkMode ? Theme.of(context).hintColor.withOpacity(.5) :Theme.of(context).primaryColor) : Padding(
