...
class WalletTransactionListWidget extends StatefulWidget {
  ...
  const WalletTransactionListWidget({super.key, required this.walletController, required this.scrollController});

  @override
  State<WalletTransactionListWidget> createState() => _WalletTransactionListWidgetState();
}

class _WalletTransactionListWidgetState extends State<WalletTransactionListWidget> {
  @override
  Widget build(BuildContext context) {
    ...
    ):const NoDataWidget(title: 'no_transaction_found',):SizedBox(height: Get.height, child: const NotificationShimmerWidget());
  }
}
