...
/*    pusherClient!.subscribe("private-customer-coupon-applied.$tripId").bind("customer-coupon-applied.$tripId", (event) async{
      Get.find<RideController>().getFinalFare(jsonDecode(event!.data!)['id']);
    //  pusherClient!.unsubscribe("private-customer-coupon-applied.$tripId");
    });*/

/*    pusherClient!.subscribe("private-customer-coupon-removed.$tripId").bind("customer-coupon-removed.$tripId", (event) async{
      Get.find<RideController>().getFinalFare(jsonDecode(event!.data!)['id']);
      //  pusherClient!.unsubscribe("private-customer-coupon-applied.$tripId");
    });*/
  }
