                        ...
                        child: GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(childAspectRatio: 1,
                          ...
                          itemBuilder: (BuildContext context, index) {
                            ...
                            return isImage ? Padding( padding: const EdgeInsets.only(right: 5,top: 0,bottom: 5),
                                child: InkWell(onTap: ()=> PopupBanner(context: context, images: images, initIndex: index,dotsAlignment: Alignment.bottomCenter,onClick: (index){},autoSlide: false,height: MediaQuery.of(context).size.height*0.9,fit: BoxFit.fitWidth).show(),
