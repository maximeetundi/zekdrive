  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProfileController>(builder: (profileController) {
      ...
      return Column(children: [
                        ...
                        child: Stack(children: [
                          ClipRRect(borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                            child:  SizedBox(height: MediaQuery.of(context).size.width/4.3,
                              ...
                              child: ImageWidget(image: "${Get.find<ConfigController>().config?.imageBaseUrl?.identityImage}/${profileController.profileModel?.data?.identificationImage?[index]??''}"))),
        ...
        profileController.isUpdating ?  Center(child: SpinKitCircle(color: Theme.of(context).primaryColor, size: 40.0,)) : ButtonWidget (
