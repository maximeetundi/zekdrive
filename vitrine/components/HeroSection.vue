      ...
      <div class="hero-grid">
        ...
        <div class="hero-content">
          <div class="hero-badge">
            ...
            <span>4.9/5 · +50 000 utilisateurs actifs</span>
          </div>

          <h1 class="hero-title">
            La mobilité urbaine
            <span class="highlight">réinventée</span>
            en Afrique
          </h1>

          <p class="hero-sub">
            VTC, moto-taxi, livraison — rapide, fiable et abordable. ZekDrive vous connecte aux meilleurs chauffeurs en moins de 3 minutes.
          </p>
          ...
          <div class="hero-stats">
            ...
            <div>
              ...
              <div class="hero-stat-label">Chauffeurs</div>
            </div>
            <div>
